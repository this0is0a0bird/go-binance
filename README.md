...
[![Build Status](https://travis-ci.org/cctip/go-binance.svg?branch=master)](https://travis-ci.org/cctip/go-binance)
[![GoDoc](https://godoc.org/github.com/cctip/go-binance?status.svg)](https://godoc.org/github.com/cctip/go-binance)
[![Go Report Card](https://goreportcard.com/badge/github.com/cctip/go-binance)](https://goreportcard.com/report/github.com/cctip/go-binance)
[![codecov](https://codecov.io/gh/cctip/go-binance/branch/master/graph/badge.svg)](https://codecov.io/gh/cctip/go-binance)
...
```shell
go get github.com/cctip/go-binance/v2
```

For v1 API, it has been moved to `v1` branch, please use:

```shell
go get github.com/cctip/go-binance/v1
```
...
```golang
import (
    "github.com/cctip/go-binance/v2"
)
```
...
Following are some simple examples, please refer to [godoc](https://godoc.org/github.com/cctip/go-binance) for full references.
