...
type GetAccountApiTradeStatusService struct {
	c           *Client
}

func (s *GetAccountApiTradeStatusService) Do(ctx context.Context, opts ...RequestOption) (res *AccountApiTradeStatusResponse, err error) {
	r := &request{
		method:   http.MethodGet,
...
type AccountApiTradeStatusResponse struct {
	Data  AccountApiTradeStatus `json:"data"`
}

type AccountApiTradeStatus struct {
...
type GetAccountApiPermListService struct {
	c           *Client
}

func (s *GetAccountApiPermListService) Do(ctx context.Context, opts ...RequestOption) (res *GetAccountApiPermResponse, err error) {
	r := &request{
		method:   http.MethodGet,
...
type GetAccountApiPermResponse struct {
