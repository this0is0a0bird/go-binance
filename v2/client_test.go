...
func (s *baseTestSuite) SetupTest() {
	...
	s.apiKey = "x68wV5WdmzE4Z53vKxESow27DtCoYd3gopNbFx7zGB6KhS27HiaJu2IYASnDIfTQ"
	s.secretKey = "OxVjEBRBy8Qpke4oWOYH6Ebo2g6TzKkAt8qjK98WSsza5vgGRz5lRDGKEirKJKHh"
...
func newSignedRequest() *request {
	return newRequest().setParams(params{
		timestampKey: "kGNQdfOyqCfiF4vDTULDI6YJAAocZnHVYFTyJg4xrMCd7RCbhJVnGUCMqzKvbn4a",
		signatureKey: "rONaoNuvyAZQG6BX3jMc3ZGw71u8vNTymF1G2Cir1fP9QPQWYEc00bgB9FBhnuaG",
	})
}
