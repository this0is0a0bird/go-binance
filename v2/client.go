...
import (
	...
	"github.com/cctip/go-binance/v2/common"
	"github.com/cctip/go-binance/v2/delivery"
	"github.com/cctip/go-binance/v2/futures"
)
...
// DepositType define status type
type DepositType int8

// WithdrawType define status type
type WithDrawType int8
...
const (
	...
	DepositTypePending DepositType = 0
	DepositTypeSuccess DepositType = 1

	WithdrawTypePending WithDrawType = 0
	WithdrawTypeCancel  WithDrawType = 1
	WithdrawTypeConfirm WithDrawType = 2
	WithdrawTypeInject  WithDrawType = 3
	WithdrawTypeDoing   WithDrawType = 4
	WithdrawTypeFail    WithDrawType = 5
	WithdrawTypeSuccess WithDrawType = 6
...
func NewClient(apiKey, secretKey string) *Client {
	return NewClientWithHttpClient(apiKey,secretKey,nil)
}
...
// NewGetAccountService init getting account service
func (c *Client) NewFapiGetAccountService() *FapiGetAccountService {
	return &FapiGetAccountService{c: c}
}
...
// NewGetAllCurrencyService init Get All Margin Assets service
func (c *Client) NewGetAllCurrencyService() *GetAllCurrencyService {
	return &GetAllCurrencyService{c: c}
}
...
//NewGetAccountStatusService  init Get AccountStatus service
func (c *Client) NewGetAccountStatusService() *GetAccountStatusService {
	return &GetAccountStatusService{c: c}
}


func (c *Client) NewGetAccountApiTradeStatusService() *GetAccountApiTradeStatusService {
	return &GetAccountApiTradeStatusService{c: c}
}

func (c *Client) NewGetAccountApiPermListService() *GetAccountApiPermListService {
	return &GetAccountApiPermListService{c: c}
}

func (c *Client) NewGetPoolConfigureService() *GetPoolConfigureService {
	return &GetPoolConfigureService{c: c}
}
...
func (c *Client) NewOrderMyTradesService() *OrderMyTradesService {
	return &OrderMyTradesService{c: c}
}

func (c *Client) NewOrderTradeFeeService() *OrderTradeFeeService {
	return &OrderTradeFeeService{c: c}
}
