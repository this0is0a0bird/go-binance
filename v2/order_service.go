...
// OrderRateLimitService cancel all active orders on the list order.
type OrderRateLimitService struct {
	c                 *Client
}

// Do send request
func (s *OrderRateLimitService) Do(ctx context.Context, opts ...RequestOption) (res []*OrderRateLimitItem, err error) {
	r := &request{
		method:   http.MethodGet,
...
type OrderRateLimitItem struct {
...
// /api/v3/myTrades
// OrderMyTradesService cancel all active orders on the list order.
type OrderMyTradesService struct {
	c         *Client
	symbol    string
	orderId   string
	startTime *int64
...
// Symbol set symbol
func (s *OrderMyTradesService) Symbol(symbol string) *OrderMyTradesService {
	s.symbol = symbol
	return s
}

// orderId sets orderId
func (s *OrderMyTradesService) OrderId(orderId string) *OrderMyTradesService {
	s.orderId = orderId
	return s
}

// startTime sets startTime
func (s *OrderMyTradesService) StartTime(startTime int64) *OrderMyTradesService {
	s.startTime = &startTime
	return s
}

// endTime sets endTime
func (s *OrderMyTradesService) EndTime(endTime int64) *OrderMyTradesService {
	s.endTime = &endTime
	return s
}

// Do send request
func (s *OrderMyTradesService) Do(ctx context.Context, opts ...RequestOption) (res []*OrderMyTradesItem, err error) {
	r := &request{
		method:   http.MethodGet,
...
// OrderMyTradesService cancel all active orders on the list order.
type OrderTradeFeeService struct {
	c         *Client
	symbol    string
}

// Symbol set symbol
func (s *OrderTradeFeeService) Symbol(symbol string) *OrderTradeFeeService {
	s.symbol = symbol
	return s
}

// Do send request
func (s *OrderTradeFeeService) Do(ctx context.Context, opts ...RequestOption) (res []*TradeFeeItem, err error) {
	r := &request{
		method:   http.MethodGet,
